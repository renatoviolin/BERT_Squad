...
wget -P dataset/ -c https://rajpurkar.github.io/SQuAD-explorer/dataset/train-v2.0.json
wget -P dataset/ -c https://rajpurkar.github.io/SQuAD-explorer/dataset/dev-v2.0.json
wget -P dataset/ -c https://rajpurkar.github.io/SQuAD-explorer/dataset/train-v1.1.json
wget -P dataset/ -c https://rajpurkar.github.io/SQuAD-explorer/dataset/dev-v1.1.json
